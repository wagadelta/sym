            ...
            <table class="well table table-striped tablb-condensed color-text-b ">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{!! $corredor->carrera->nombre!!}</td>
                  <td>
                    ( {!! $corredor->etiqueta_count !!} ) <a href ="{{ asset('corredores') }}/{!! $corredor->bib_number !!}/{!! $corredor->carrera->id !!}/images" title="Ver imágenes relacionadas">
