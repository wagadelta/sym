...
<div class="col-md-8 div-center">
  ...
  <div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12">
    ...
    <!--div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"> <p class="text-justify parr"> {--{ $descript }--} </p> </div-->
    ...
    <div class="row center col-md-12">
        <p class="text-justify parr2"> Disfruta y comparte las fotos que más te gusten. Envía tus sugerencias y comentarios al correo soporte.t4m@gmail.com </p>
